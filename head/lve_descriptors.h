...
namespace lve {
    ...
    public:
        //build des layouts - blueprints
        class Builder {
        public:
            Builder(LveDevice& lveDevice) : lveDevice{ lveDevice } {}
            //information of vulkan requires
            Builder& addBinding(
                uint32_t binding,
    ...
    public:
        ...
        public:
            Builder(LveDevice& lveDevice) : lveDevice{ lveDevice } {}
            //how many des of each type
            Builder& addPoolSize(VkDescriptorType descriptorType, uint32_t count);
            //behavior of the pool object
            Builder& setPoolFlags(VkDescriptorPoolCreateFlags flags);
            //total number of descriptor sets
    ...
    //building the actual descriptor objects easier
