...
namespace lve {
    ...
    //checks to make sure a binding at the specified index hasn't already been added and then configure the full construct with the descriptor's layout
    ...
    LveDescriptorPool::LveDescriptorPool(
        ...
        descriptorPoolInfo.poolSizeCount = static_cast<uint32_t>(poolSizes.size()) * 2;
