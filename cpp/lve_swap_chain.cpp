...
void LveSwapChain::createSwapChain() {
  ...
  VkPresentModeKHR presentMode = chooseSwapPresentMode(swapChainSupport.presentModes);   //mailbox latency lower than fifo, but cost more, usually not be used in mobile
